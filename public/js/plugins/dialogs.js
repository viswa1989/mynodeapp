 ...
 * Confirm Dialog Controller 
 */
ctrlrs.controller('removeDialogCtrl',['$scope','$uibModalInstance','$translate','data',function($scope,$uibModalInstance,$translate,data){
	//-- Variables -----//
...
}]); // end removeDialogCtrl / dialogs.controllers
//== Services ================================================================//
//== Services ================================================================//
/**
 * Confirm Dialog Controller 
 */
ctrlrs.controller('disableDialogCtrl',['$scope','$uibModalInstance','$translate','data',function($scope,$uibModalInstance,$translate,data){
	//-- Variables -----//
 ...
 * Confirm Dialog Controller 
 */
ctrlrs.controller('enableDialogCtrl',['$scope','$uibModalInstance','$translate','data',function($scope,$uibModalInstance,$translate,data){
	//-- Variables -----//
...
angular.module('dialogs.services',['ui.bootstrap.modal','dialogs.controllers'])
	...
	.provider('dialogs',[function(){
		...
		var _w = 'dialogs-default noty_modalbox'; // windowClass
		...
		this.$get = ['$uibModal',function ($uibModal){
			...
			return {
				 ...
				 * @param	opts	object
				 */
				remove : function(header,msg,opts){
					opts = _setOpts(opts);

					return $uibModal.open({
						templateUrl : '/dialogs/remove.html',
				 ...
				 * @param	opts	object
				 */
				disable : function(header,msg,opts){
					opts = _setOpts(opts);

					return $uibModal.open({
						templateUrl : '/dialogs/disable.html',
						controller : 'disableDialogCtrl',
						backdrop: opts.bd,
						backdropClass: opts.bdc,
						keyboard: opts.kb,
						windowClass: opts.wc,
				 ...
				 * @param	opts	object
				 */
				enable : function(header,msg,opts){
					opts = _setOpts(opts);

					return $uibModal.open({
						templateUrl : '/dialogs/enable.html',
						controller : 'enableDialogCtrl',
						backdrop: opts.bd,
						backdropClass: opts.bdc,
						keyboard: opts.kb,
						windowClass: opts.wc,
...
angular.module('dialogs.main',['dialogs.services','ngSanitize']) // requires angular-sanitize.min.js (ngSanitize) //code.angularjs.org/1.2.1/angular-sanitize.min.js
	...
	.config(['$translateProvider','dialogsProvider',function($translateProvider,dialogsProvider){
		...
		try{
			...
			$translateProvider.translations('en-US',{
	            ...
	            DIALOGS_OK: "OK",
	            DIALOGS_YES: "Yes",
				DIALOGS_YES_DESC: "Yes, Remove it.",
                                DIALOGS_YES_DISABLE: "Yes, Disable it.",
                                DIALOGS_YES_ENABLE: "Yes, Enable it.",
	            DIALOGS_NO: "Cancel"
        	});
		} // end try/catch
	...
	.run(['$templateCache','$interpolate',function($templateCache,$interpolate){
    	...
    	$templateCache.put('/dialogs/confirm.html','<div class="modal-header dialog-header-confirm"><button type="button" class="close" ng-click="no()">&times;</button><h4 class="modal-title"><span class="'+startSym+'icon'+endSym+'"></span> '+startSym+'header'+endSym+'</h4></div><div class="modal-body" ng-bind-html="msg"></div><div class="modal-footer"><button type="button" class="btn btn-primary notify_cancel_btn" ng-click="no()">'+startSym+'"DIALOGS_NO" | translate'+endSym+'</button><button type="button" class="btn btn-default notify_confirm_btn" ng-click="yes()">'+startSym+'"DIALOGS_YES" | translate'+endSym+'</button></div>');
        $templateCache.put('/dialogs/remove.html','<div class="modal-header dialog-header-confirm"><button type="button" class="close" ng-click="no()">&times;</button><h4 class="modal-title"><span class="'+startSym+'icon'+endSym+'"></span> '+startSym+'header'+endSym+'</h4></div><div class="modal-body" ng-bind-html="msg"></div><div class="modal-footer"><button type="button" class="btn btn-primary notify_cancel_btn" ng-click="no()">'+startSym+'"DIALOGS_NO" | translate'+endSym+'</button><button type="button" class="btn btn-default notify_confirm_btn" ng-click="yes()">'+startSym+'"DIALOGS_YES_DESC" | translate'+endSym+'</button></div>');
        $templateCache.put('/dialogs/disable.html','<div class="modal-header dialog-header-confirm"><button type="button" class="close" ng-click="no()">&times;</button><h4 class="modal-title"><span class="'+startSym+'icon'+endSym+'"></span> '+startSym+'header'+endSym+'</h4></div><div class="modal-body" ng-bind-html="msg"></div><div class="modal-footer"><button type="button" class="btn btn-primary notify_cancel_btn" ng-click="no()">'+startSym+'"DIALOGS_NO" | translate'+endSym+'</button><button type="button" class="btn btn-default notify_confirm_btn" ng-click="yes()">'+startSym+'"DIALOGS_YES_DISABLE" | translate'+endSym+'</button></div>');
        $templateCache.put('/dialogs/enable.html','<div class="modal-header dialog-header-confirm"><button type="button" class="close" ng-click="no()">&times;</button><h4 class="modal-title"><span class="'+startSym+'icon'+endSym+'"></span> '+startSym+'header'+endSym+'</h4></div><div class="modal-body" ng-bind-html="msg"></div><div class="modal-footer"><button type="button" class="btn btn-primary notify_cancel_btn" ng-click="no()">'+startSym+'"DIALOGS_NO" | translate'+endSym+'</button><button type="button" class="btn btn-default notify_confirm_btn" ng-click="yes()">'+startSym+'"DIALOGS_YES_ENABLE" | translate'+endSym+'</button></div>');
