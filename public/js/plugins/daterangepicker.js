...
(function(root, factory) {
  ...
  // Finally, as a browser global.
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        this.parentEl = '.dtrange_fixed_postion';
            ...
            options.template = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="ranges">' +
                    '<div class="range_inputs">' +
                        '<button class="applyBtn btn btn-sm btn-success" ype="button">Apply</button> ' +
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function(side) {
            ...
            if ((!minDate || minDate.isBefore(calendar.firstDay)) && (!this.linkedCalendars || side == 'left')) {
                html += '<th class="prev available"><i class="fa fa-chevrons-left glyphicon glyphicon-chevron-left"></i></th>';
            } else {
                html += '<th></th>';
            }
            ...
            if ((!maxDate || maxDate.isAfter(calendar.lastDay)) && (!this.linkedCalendars || side == 'right' || this.singleDatePicker)) {
                html += '<th class="next available"><i class="fa fa-chevrons-right glyphicon glyphicon-chevron-right"></i></th>';
            } else {
                html += '<th></th>';
            }
        ...
        show: function(e) {
            ...
            this.updateView();
            this.container.show();
			$('.report_date_show').css('display','block');
            this.move();
        ...
        hide: function(e) {
			...
			$('.report_date_show').css('display','none');
