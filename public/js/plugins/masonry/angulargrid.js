                ...
                afterImageLoad(clones, {
                  ...
                  onFullLoad: function() {
                    ...
                    for (i = 0, ln = listElms.length; i < ln; i++) {
                      ...
                      if(top > 0){
                          if(colInfo.no && colInfo.no>0){
                            var quotient = parseInt(i/colInfo.no);
                            top -= quotient * 15;
                            arcol[col] = top + height + options.gutterSize - (parseInt(i/colInfo.no) * 7);
                          } else {
                            arcol[col] = top + height + options.gutterSize - 10;
                            top -= 15;
                          }
                      } else {
                          arcol[col] = top + height + options.gutterSize - 10;
                    ...
                    var contHeight = Math.max.apply(Math, arcol);
